...
public class Filme {
	private int id;
	@NotNull
	@Size(min=2, max=100, message="O tamanho máximo do título deve ser entre 2 e 100 caracteres")
	private String titulo;
	@NotNull
	@Size(min=20, max=4000, message="O tamanho máximo da descrição deve ser entre 20 e 4000 caracteres")
